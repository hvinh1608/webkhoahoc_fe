                            ...
                            <template v-for="(v, k) in list" :key="k">
                                <tr class="align-middle">
                                    ...
                                    <td class="text-center">
                                        <button v-on:click="doiKichHoat(v)" v-if="v.is_active == 0" class="btn btn-danger btn-sm">
                                            Chưa Kích Hoạt
                                        </button>
                                        <button v-on:click="doiKichHoat(v)" v-else class="btn btn-success btn-sm">
                                            Đã Kích Hoạt
                                        </button>
                                    </td>
                                    <td>
...
export default {
    ...
    methods: {
        ...
        doiKichHoat(value) {
            axios
                .post(
                    "http://127.0.0.1:8000/api/admin/khach-hang/change-status-KH",
                    value,
                    {
                        headers: {
                            Authorization: "Bearer " + localStorage.getItem("key_admin"),
