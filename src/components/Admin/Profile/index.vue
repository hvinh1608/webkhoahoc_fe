                                    ...
                                    <div class="card flex-fill">
                                        <div class="card-body">
                                            <div class="d-flex flex-column align-items-center text-center">
                                                <img src="https://png.pngtree.com/png-clipart/20190516/original/pngtree-vector-businessman-icon-png-image_4171324.jpg"
                                    ...
                                    <div class="card flex-fill">
                                        <div class="card-body">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-lg-9 text-secondary">
                                                    <input v-model="thong_tin.dia_chi" type="text" class="form-control"
