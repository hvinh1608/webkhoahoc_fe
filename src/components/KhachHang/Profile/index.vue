        ...
        <div class="card">
            <div class="card-body">
                <ul class="nav nav-tabs nav-primary" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" data-bs-toggle="tab" href="#naptienTK" role="tab" aria-selected="false" tabindex="-1">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="card flex-fill">
                                    <div class="card-body">
                                        <div class="d-flex flex-column align-items-center text-center">
                                            <img src="https://www.caythuocdangian.com/wp-content/uploads/anh-dai-dien-47.jpg" style="width: 140px; height: 140px;" alt="Admin" class="rounded-circle p-1 bg-primary">
                                            <div class="mt-3">
                                                ...
                                                <p>Số dư: {{ formatVND(thong_tin.so_du) }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-lg-9 text-secondary">
                                                <input type="text" v-model="thong_tin.ho_va_ten" class="form-control" placeholder="Nhập họ và tên">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col-lg-3">
                                            ...
                                            <div class="col-lg-9 text-secondary">
                                                <input disabled v-model="thong_tin.email" type="text" class="form-control" placeholder="Nhập email">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col-lg-3">
                                            ...
                                            <div class="col-lg-9 text-secondary">
                                                <input v-model="thong_tin.so_dien_thoai" type="text" class="form-control" placeholder="Nhập số điện thoại">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col-lg-3">
                                            ...
                                            <div class="col-lg-9 text-secondary">
                                                <input v-model="thong_tin.ngay_sinh" type="date" class="form-control" placeholder="Nhập số điện thoại">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-3"></div>
                                            <div class="col-lg-9 text-secondary">
                                                <button type="button" class="btn btn-primary px-4" @click="thayDoiThongTin()">Lưu</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 text-end">
                                                <button v-on:click="xacNhanNapTien()" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#xacNhanNapTienModal">Nạp
                                                    Tiền</button>
                                            </div>
                                        </div>
                                    </div>
...
<!-- Modal nạp tiền -->
<div class="modal fade" id="xacNhanNapTienModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div v-if="qrVisible" class="alert alert-info" role="alert">
                                    Mã QR sẽ hết hạn sau: {{ countdown }} giây
                                </div>
